...
-- Shipping 데이터
INSERT INTO shipping (id, member_id, rental_id, tracking_number, direction, status,
                      receiver, phone_number,
                      postcode, post_address, detail_address,
                      created_at, start_at, end_at)
VALUES
    (1, 1, 1, '25090213363012345678', 'OUTBOUND', 'DELIVERED',
     '테스터1', '01012345678', '12345', '서울시 강남구', '테스트동 123-1',
     '2025-01-10 11:00:00', '2025-01-10 12:00:00', '2025-01-12 10:00:00'),

    (2, 1, 1, '25091113363012345679', 'INBOUND', 'PENDING',
     '테스터1', '01012345678', '12345', '서울시 강남구', '테스트동 123-1',
     '2025-01-20 10:00:00', NULL, NULL),

    (3, 2, 2, '25090513363012345680', 'OUTBOUND', 'DELIVERED',
     '테스터2', '01087654321', '54321', '부산시 해운대구', '테스트동 456-2',
     '2025-01-11 15:00:00', '2025-01-11 16:00:00', '2025-01-13 11:00:00'),

    (4, 2, 2, '25090513363012312410', 'INBOUND', 'PENDING',
     '테스터2', '01087654321', '54321', '부산시 해운대구', '테스트동 456-2',
     '2025-01-18 10:00:00', NULL, NULL),

    (5, 3, 3, '25090513361231212410', 'OUTBOUND', 'DELIVERED',
     '테스터3', '01011112222', '67890', '대구시 수성구', '테스트동 789-3',
     '2025-01-05 10:00:00', '2025-01-05 11:00:00', '2025-01-07 09:00:00'),

    (6, 3, 3, '25090513123412311680', 'INBOUND', 'DELIVERED', '테스터3',
     '01011112222', '67890', '대구시 수성구', '테스트동 789-3',
     '2025-01-10 10:00:00', '2025-01-10 11:00:00', '2025-01-11 10:00:00');
