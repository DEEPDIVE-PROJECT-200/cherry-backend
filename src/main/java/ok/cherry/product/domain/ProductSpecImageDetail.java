...
public class ProductSpecImageDetail {

	private String imageUrl;

	private Integer displayOrder;

	public static ProductSpecImageDetail create(String imageUrl, Integer displayOrder) {
		ProductSpecImageDetail detail = new ProductSpecImageDetail();
