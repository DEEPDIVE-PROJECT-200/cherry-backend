...
public class ErrorTestController {
	...
	/**
	 * 11. @RequestBody 누락 테스트 - HttpMessageNotReadableException
	 * POST /api/test/errors/missing-body
	 * (body 없이 POST 요청)
	 */
	@PostMapping("/missing-body")
	public ResponseEntity<String> testMissingRequestBody(@RequestBody TestRequestDTO request) {
		return ResponseEntity.ok("요청 성공: " + request.getName());
	}
}
